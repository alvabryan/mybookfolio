  ...
  portfolioContet = [
    ...
    },
    {
      ...
      [
        ...
        {name: 'Resume', url: 'resume', imageUrl: 'https://www.mybookfolio.com/cadets/imagesCards/resume.png', progress: '100%'},
        // tslint:disable-next-line: max-line-length
    ...
    },
    {
      ...
      [
        // tslint:disable-next-line: max-line-length
        {name: 'Course Work', url: 'course-work', imageUrl: 'https://www.mybookfolio.com/cadets/imagesCards/courseWork.png', progress: '100%'},
        {name: 'Essay', url: 'essay', imageUrl: 'https://www.mybookfolio.com/cadets/imagesCards/essay.png', progress: '100%'},
        // tslint:disable-next-line: max-line-length
        {name: 'Let 1-4 Lesson Evidence', url: 'lesson-evidence', imageUrl: 'https://www.mybookfolio.com/cadets/imagesCards/books.png', progress: '100%'},
        // tslint:disable-next-line: max-line-length
        {name: 'Written Summary', url: 'written-summary', imageUrl: 'https://www.mybookfolio.com/cadets/imagesCards/edit.png', progress: '100%'}
      ]
    },
    {
      name: 'Awards', cards:
