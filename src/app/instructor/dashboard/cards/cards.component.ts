...
import { Subscription, forkJoin, of, merge, from, combineLatest } from 'rxjs';
...
export class CardsComponent implements OnInit, OnDestroy {
  ...
  portfolioContet = [
    {
      ...
      [
        ...
        // tslint:disable-next-line: max-line-length
        {name: 'Success Profiler and Personal Growth Plan', url: 'course-work_successProfiler', imageUrl: 'https://www.mybookfolio.com/cadets/imagesCards/successPro.png', progress: '0'},
        // tslint:disable-next-line: max-line-length
    ...
    },
    {
      ...
      [
        ...
        {name: 'Resume', url: 'course-work_resume', imageUrl: 'https://www.mybookfolio.com/cadets/imagesCards/resume.png', progress: '0'},
        // tslint:disable-next-line: max-line-length
        {name: 'Achievements', url: 'course-work_achievements', imageUrl: 'https://www.mybookfolio.com/cadets/imagesCards/medal.png', progress: '0'}
      ]
    },
    {
  ...
  constructor(private route: ActivatedRoute, private router: Router, private store: Store<fromInstructor.State>, private getProgressService: CardProgressService) { }
    ...
    this.subscription.add(
      combineLatest(
        ...
        if (data[0].user && data[1].cadetData) {
          const letAssigned = data[0].user.letAssigned;
          const battalionProgress = data[1].cadetData.cadetProgress;
          const progress: any = this.getProgressService.determineCadetProgress(letAssigned, battalionProgress);
