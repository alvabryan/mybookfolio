  ...
  portfolioContet = [
    {
      ...
      [
        ...
        // tslint:disable-next-line: max-line-length
        {name: 'Success Profiler and Personal Growth Plan', url: 'course-work_successProfiler', imageUrl: 'https://www.files.mybookfolio.com/imagesCards/successPro.png', progress: '0'},
        // tslint:disable-next-line: max-line-length
    ...
    },
    {
      ...
      [
        ...
        {name: 'Resume', url: 'course-work_resume', imageUrl: 'https://www.files.mybookfolio.com/imagesCards/resume.png', progress: '0'},
        // tslint:disable-next-line: max-line-length
        {name: 'Achievements', url: 'course-work_achievements', imageUrl: 'https://www.files.mybookfolio.com/imagesCards/medal.png', progress: '0'}
      ]
    },
    {
